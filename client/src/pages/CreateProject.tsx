  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Header Banner */}
        <div className="p-6 sm:p-8 rounded-xl bg-white border border-slate-200 mb-8 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="h-14 w-14 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 text-xs rounded-md bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
              />
              {errors.title && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                  Course Project Category <span className="text-red-500">*</span>
                </label>
                <select
                  {...register('courseType')}
                  className="w-full px-4 py-2.5 text-xs rounded-md bg-white border border-slate-200 text-slate-900 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                >
                ...
                {errors.courseType && (
                  <p className="mt-1 text-xs text-red-500">{errors.courseType.message}</p>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                  Student Team Capacity (1 - 5 students) <span className="text-red-500">*</span>
                </label>
                <input
                  type="number"
                  min="1"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 text-xs rounded-md bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
              />
              {errors.description && (
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-end gap-3 border-t border-slate-100">
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 rounded-md text-xs font-medium text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 rounded-md text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 shadow-sm transition-all disabled:opacity-50"
              >
